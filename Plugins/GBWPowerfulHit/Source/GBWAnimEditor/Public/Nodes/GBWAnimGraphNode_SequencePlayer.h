...
#include "GBWAnimGraphNode_SequencePlayer.generated.h"

class FBlueprintActionDatabaseRegistrar;

UCLASS()
class GBWANIMEDITOR_API UGBWAnimGraphNode_SequencePlayer : public UAnimGraphNode_AssetPlayerBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FGBWAnimNode_SequencePlayer Node;
